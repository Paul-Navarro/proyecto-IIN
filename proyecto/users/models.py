...
class Notificacion(models.Model):
    ...
    @class Notificacion
    @extends models.Model
    @description Modelo que representa una notificación enviada a un usuario. Cada notificación contiene un título, una descripción, un estado de lectura y una fecha de creación.
    '''
...
class Venta(models.Model):
    ...
    @class Venta
    @extends models.Model
    @description Modelo que representa una venta realizada en el sistema. Los detalles específicos de la venta se definen en los campos adicionales (a definir).
    '''
    ...
    class Meta:
        '''
        @class Meta
        @description Define permisos personalizados para el modelo 'Venta', permitiendo a ciertos usuarios ver y filtrar las ventas.
        @permissions
            @permission view_sales - Permite a los usuarios ver las ventas.
            @permission filter_sales - Permite a los usuarios filtrar las ventas.
        '''
        permissions = [
